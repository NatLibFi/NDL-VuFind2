...
class FinnaResourceList implements FinnaResourceListEntityInterface
{
    ...
    protected string $list_config_identifier = '';
    ...
    protected ?DateTime $pickup_date = null;
    ...
    public function __construct()
    {
        ...
        $this->pickup_date = $this->getUnassignedDefaultDateTime();
    }
    ...
    {
        $this->pickup_date = $this->getNullableDateTimeFromNonNullable($pickup_date);
        return $this;
    }
    ...
    {
        return $this->getNullableDateTimeFromNonNullable($this->pickup_date);
    }
