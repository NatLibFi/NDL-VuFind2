    ...
    DbServiceAwareInterface
{
    ...
    public function getListsContainingResource(
        ...
        $dql = 'SELECT frl FROM ' . FinnaResourceListEntityInterface::class . ' frl '
            ...
            . 'WHERE r.recordId = :recordId AND frl.user = :userId '
            . 'ORDER BY frl.title';
    ...
    public function getResourceListsForUser(
        ...
        if ($listIdentifier) {
            $dql .= ' AND frl.list_config_identifier = :list_config_identifier ';
            $parameters['list_config_identifier'] = $listIdentifier;
        }
        if ($institution) {
        ...
        if ($listType) {
            $dql .= ' AND frl.list_type = :listType ';
