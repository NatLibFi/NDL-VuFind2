...
/**
 * Table Definition for finna_resource_list_handler
 *
 * PHP version 8
 *
 ...
 * @link     https://vufind.org Main Page
 */
class FinnaResourceListHandler extends Gateway implements DbServiceAwareInterface
{
    ...
    public function __construct(
        ...
        $table = 'finna_resource_list_handler'
    ) {
