<?php
/**
 * Table Definition for finna_record_stats_record
 *
 * PHP version 7
 *
...
/**
 * Table Definition for finna_record_stats_records
 *
 * @category VuFind
 * @package  Db_Table
 * @author   Ere Maijala <ere.maijala@helsinki.fi>
...
class FinnaRecordViewRecord extends \VuFind\Db\Table\Gateway
{
     ...
     * already exist?
     * @param bool                $update   Should we update any existing record as
     * necessary?
     *
