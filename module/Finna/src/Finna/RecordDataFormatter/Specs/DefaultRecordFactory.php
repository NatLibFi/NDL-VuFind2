...
class DefaultRecordFactory implements FactoryInterface
{
    ...
    public function __invoke(
        ...
        $datasourceConfig = $container->get(\VuFind\Config\PluginManager::class)->get('datasources')->toArray();
        return new $requestedName($config, $schemaOrgHelper, $datasourceConfig);
    }
}
