...
$config = [
    ...
    'icons' => [
        ...
        'aliases' => [
            'authority-search' => 'Alias:search',
            'advanced-search' => 'FinnaIcons:adv-search',
            'basic-search' => 'Alias:search',
            'eds-search' => 'Alias:search',
            'primo-search' => 'Alias:search',
            'edit-search' => 'FontAwesome:pen',
            'back-to-results' => 'FinnaIcons:arrow-left',
            'mobilemenu-bars' => 'FinnaIcons:bars',
            'mobilemenu-close' => 'FinnaIcons:remove',
            'cart' => 'FontAwesome:suitcase',
            'cart-email' => 'FontAwesome:envelope',
            'cart-export' => 'FontAwesome:list-alt',
            'cart-empty' => 'FontAwesome:remove',
            'cart-remove' => 'FontAwesome:trash',
            'cart-print' => 'FontAwesome:print',
            'cart-save' => 'FontAwesome:save',
            'clear-button' => 'FinnaIcons:reset',
            ...
            'pagination-right' => 'FinnaIcons:arrow-right-circle-filled',
            ...
            'pager-previous' => 'FinnaIcons:arrow-left-circle-filled',
            'phone' => 'FontAwesome:phone-square',
            'public' => 'FinnaIcons:public',
            'tabs-detail' => 'FontAwesome:code',
