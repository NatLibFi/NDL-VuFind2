...
$config = [
    ...
    'icons' => [
        ...
        'aliases' => [
            ...
            'authority-more' => 'FontAwesome:arrow-right',
            ...
            'cart-export' => 'FontAwesome:list-alt',
            ...
            'condensed-view' => 'FinnaIcons:list-compressed', #todo
            'contact-email' => 'FontAwesome:at',
            ...
            'facet-status' => 'FontAwesome:check',
            ...
            'filter-expand' => 'FinnaIcons:arrow-down-1',
            'filter-collapse' => 'FontAwesome:arrow-up',
            'google-plus' => 'FinnaIcons:google+',
            'help' => 'FinnaIcons:help-circle',
            'home' => 'FinnaIcons:home',
            'hierarchy' => 'FinnaIcons:sitemap',
            'condensed-expand' => 'FinnaIcons:arrow-right-1',
            'condensed-collapse' => 'FinnaIcons:arrow-down-1',
            'holdings-locations-expand' => 'FontAwesome:arrow-down',
            'holdings-locations-collapse' => 'FontAwesome:arrow-up',
            ...
            'image-information-show' => 'FontAwesome:arrow-down',
            'image-information-hide' => 'FontAwesome:arrow-up',
            'images-next' => 'FontAwesome:chevron-right',
            'images-previous' => 'FontAwesome:chevron-left',
            'images-less' => 'FontAwesome:arrow-up',
            'images-more' => 'FontAwesome:arrow-down',
            ...
            'list-public' => 'FontAwesome:public',
            'login' => 'Alias:user',
            ...
            'pager-first' => 'FinnaIcons:arrow-left-circle',
            'pager-last' => 'FinnaIcons:arrow-right-circle',
            'pager-next' => 'FinnaIcons:arrow-right-circle-filled',
            'pager-prev' => 'FinnaIcons:arrow-left-circle-filled',
            'paginate-next' => 'FontAwesome:arrow-right',
            'paginate-prev' => 'FontAwesome:arrow-left',
            'pagination-first' => 'FinnaIcons:chevrons-right-circle-filled',
            'pagination-last' => 'FinnaIcons:chevrons-left-circle-filled',
            'pagination-next' => 'FinnaIcons:arrow-right-circle-filled',
            'pagination-prev' => 'FinnaIcons:-left-circle-filled',
            'pagination-simple-next' => 'FinnaIcons:arrow-right',
            'pagination-simple-prev' => 'FinnaIcons:arrow-left',
            ...
            'popup-link' => 'FontAwesome:arrow-circle-right',
            ...
            'image-rights-more' => 'FontAwesome:arrow-right',
